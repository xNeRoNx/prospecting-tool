...
export const themes: Record<Theme, ThemeConfig> = {
  ...
  slate: {
    ...
    colors: {
      ...
      secondaryForeground: 'oklch(0.88 0.01 85)',
      accent: 'oklch(0.48 0.08 270)',
      accentForeground: 'oklch(0.92 0.01 85)',
      destructive: 'oklch(0.62 0.16 20)',
      destructiveForeground: 'oklch(0.08 0.01 240)',
      muted: 'oklch(0.22 0.01 240)',
      mutedForeground: 'oklch(0.72 0.01 85)',
  ...
  forest: {
    ...
    colors: {
      ...
      foreground: 'oklch(0.12 0.04 160)',
      card: 'oklch(0.97 0.01 140)',
      cardForeground: 'oklch(0.12 0.04 160)',
      popover: 'oklch(0.99 0.005 140)',
      popoverForeground: 'oklch(0.12 0.04 160)',
      primary: 'oklch(0.38 0.16 150)',
      primaryForeground: 'oklch(0.96 0.02 140)',
      secondary: 'oklch(0.86 0.08 140)',
      secondaryForeground: 'oklch(0.16 0.04 160)',
      accent: 'oklch(0.58 0.12 130)',
      accentForeground: 'oklch(0.12 0.04 160)',
      destructive: 'oklch(0.58 0.18 15)',
      destructiveForeground: 'oklch(0.96 0.02 140)',
      muted: 'oklch(0.89 0.03 140)',
      mutedForeground: 'oklch(0.35 0.02 160)',
      border: 'oklch(0.82 0.04 140)',
      input: 'oklch(0.82 0.04 140)',
      ring: 'oklch(0.38 0.16 150)',
    }
  },
  ocean: {
    nameKey: 'themeOcean',
    colors: {
      ...
      foreground: 'oklch(0.10 0.04 240)',
      card: 'oklch(0.98 0.01 220)',
      cardForeground: 'oklch(0.10 0.04 240)',
      popover: 'oklch(0.99 0.005 220)',
      popoverForeground: 'oklch(0.10 0.04 240)',
      primary: 'oklch(0.42 0.18 230)',
      primaryForeground: 'oklch(0.96 0.02 220)',
      secondary: 'oklch(0.84 0.08 210)',
      secondaryForeground: 'oklch(0.14 0.04 240)',
      accent: 'oklch(0.55 0.14 200)',
      accentForeground: 'oklch(0.10 0.04 240)',
      destructive: 'oklch(0.60 0.16 25)',
      destructiveForeground: 'oklch(0.96 0.02 220)',
      muted: 'oklch(0.90 0.03 220)',
      mutedForeground: 'oklch(0.32 0.02 240)',
      border: 'oklch(0.80 0.04 220)',
      input: 'oklch(0.80 0.04 220)',
      ring: 'oklch(0.42 0.18 230)',
    }
  },
  sunset: {
    nameKey: 'themeSunset',
    colors: {
      ...
      foreground: 'oklch(0.12 0.03 30)',
      card: 'oklch(0.98 0.02 50)',
      cardForeground: 'oklch(0.12 0.03 30)',
      popover: 'oklch(0.99 0.01 50)',
      popoverForeground: 'oklch(0.12 0.03 30)',
      primary: 'oklch(0.50 0.20 40)',
      primaryForeground: 'oklch(0.96 0.03 50)',
      secondary: 'oklch(0.86 0.08 60)',
      secondaryForeground: 'oklch(0.16 0.03 30)',
      accent: 'oklch(0.62 0.16 25)',
      accentForeground: 'oklch(0.12 0.03 30)',
      destructive: 'oklch(0.58 0.18 15)',
      destructiveForeground: 'oklch(0.96 0.03 50)',
      muted: 'oklch(0.89 0.04 50)',
      mutedForeground: 'oklch(0.36 0.02 30)',
      border: 'oklch(0.82 0.05 50)',
      input: 'oklch(0.82 0.05 50)',
      ring: 'oklch(0.50 0.20 40)',
    }
  }
};
