...
export const ores: Ore[] = [
  // Common
  { name: "Pyrite", rarity: "Common", museumEffect: { stat: "Capacity", maxMultiplier: 0.05 } },
  { name: "Silver", rarity: "Common", museumEffect: { stat: "Shake Speed", maxMultiplier: 0.05 } },
  { name: "Copper", rarity: "Common", museumEffect: { stat: "Size Boost", maxMultiplier: 0.05 } },
  { name: "Gold", rarity: "Common", museumEffect: { stat: "Sell Boost", maxMultiplier: 0.05 } },
  { name: "Blue Ice", rarity: "Common", museumEffect: { stat: "Dig Speed", maxMultiplier: 0.05 } },
  { name: "Platinum", rarity: "Common", museumEffect: { stat: "Dig Speed", maxMultiplier: 0.05 } },
  { name: "Seashell", rarity: "Common", museumEffect: { stat: "Capacity", maxMultiplier: 0.05 } },
  { name: "Obsidian", rarity: "Common", museumEffect: { stat: "Size Boost", maxMultiplier: 0.05 } },
  { name: "Amethyst", rarity: "Common", museumEffect: { stat: "Dig Speed", maxMultiplier: 0.05 } },
  { name: "Pearl", rarity: "Common", museumEffect: { stat: "Shake Speed", maxMultiplier: 0.05 } },
  
  // Uncommon
  { name: "Titanium", rarity: "Uncommon", museumEffect: { stat: "Dig Speed", maxMultiplier: 0.08 } },
  { name: "Neodymium", rarity: "Uncommon", museumEffect: { stat: "Shake Strength", maxMultiplier: 0.08 } },
  { name: "Topaz", rarity: "Uncommon", museumEffect: { stat: "Capacity", maxMultiplier: 0.08 } },
  { name: "Smoky Quartz", rarity: "Uncommon", museumEffect: { stat: "Shake Strength", maxMultiplier: 0.08 } },
  { name: "Malachite", rarity: "Uncommon", museumEffect: { stat: "Modifier Boost", maxMultiplier: 0.08 } },
  { name: "Coral", rarity: "Uncommon", museumEffect: { stat: "Capacity", maxMultiplier: 0.08 } },
  { name: "Sapphire", rarity: "Uncommon", museumEffect: { stat: "Dig Speed", maxMultiplier: 0.08 } },
  { name: "Zircon", rarity: "Uncommon", museumEffect: { stat: "Size Boost", maxMultiplier: 0.08 } },
  
  // Rare
  { name: "Ruby", rarity: "Rare", museumEffect: { stat: "Shake Strength", maxMultiplier: 0.13 } },
  { name: "Lapis Lazuli", rarity: "Rare", museumEffect: { stat: "Dig Speed", maxMultiplier: 0.13 } },
  ...
  // Epic
  { name: "Iridium", rarity: "Epic", museumEffect: { stat: "Dig Speed", maxMultiplier: 0.2 } },
  { name: "Moonstone", rarity: "Epic", museumEffect: { stat: "Shake Speed", maxMultiplier: 0.2 } },
  { name: "Ammonite Fossil", rarity: "Epic", museumEffect: { stat: "Capacity", maxMultiplier: 0.2 } },
  { name: "Ashvein", rarity: "Epic", museumEffect: { stat: "Size Boost", maxMultiplier: 0.2 } },
  { name: "Pyronium", rarity: "Epic", museumEffect: { stat: "Sell Boost", maxMultiplier: 0.2 } },
  { name: "Emerald", rarity: "Epic", museumEffect: { stat: "Luck", maxMultiplier: 0.2 } },
  { name: "Golden Pearl", rarity: "Epic", museumEffect: { stat: "Capacity", maxMultiplier: 0.2 } },
  { name: "Cobalt", rarity: "Epic", museumEffect: { stat: "Dig Speed", maxMultiplier: 0.2 } },
  { name: "Borealite", rarity: "Epic", museumEffect: { stat: "Dig Speed", maxMultiplier: 0.2 } },
  { name: "Osmium", rarity: "Epic", museumEffect: { stat: "Size Boost", maxMultiplier: 0.2 } },
  { name: "Opal", rarity: "Epic", museumEffect: { stat: "Shake Speed", maxMultiplier: 0.2 } },
  { name: "Aurorite", rarity: "Epic", museumEffect: { stat: "Dig Speed", maxMultiplier: 0.2 } },
  
  // Legendary
  { name: "Rose Gold", rarity: "Legendary", museumEffect: { stat: "Shake Strength", maxMultiplier: 0.3 } },
  { name: "Palladium", rarity: "Legendary", museumEffect: { stat: "Sell Boost", maxMultiplier: 0.3 } },
  { name: "Cinnabar", rarity: "Legendary", museumEffect: { stat: "Size Boost", maxMultiplier: 0.3 } },
  { name: "Diamond", rarity: "Legendary", museumEffect: { stat: "Luck", maxMultiplier: 0.3 } },
  { name: "Uranium", rarity: "Legendary", museumEffect: { stat: "Modifier Boost", maxMultiplier: 0.3 } },
  { name: "Luminium", rarity: "Legendary", museumEffect: { stat: "Capacity", maxMultiplier: 0.3 } },
  { name: "Volcanic Key", rarity: "Legendary", museumEffect: { stat: "Size Boost", maxMultiplier: 0.3 } },
  ...
  // Mythic
  { name: "Pink Diamond", rarity: "Mythic", museumEffect: { stat: "Luck", maxMultiplier: 0.5 } },
  { name: "Painite", rarity: "Mythic", museumEffect: { stat: "Size Boost", maxMultiplier: 0.5 } },
